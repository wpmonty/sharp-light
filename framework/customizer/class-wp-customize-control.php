...
class WPC_Customize_Textarea_Control extends WP_Customize_Control {
	...
	public function render_content() {
		?>
		<label>
                        <?php if (! empty( $this->label ) ) { echo '<span class="customize-control-title">' . esc_html( $this->label ) . '</span>'; } ?>
                        <?php if (! empty( $this->description )) { echo '<span class="description customize-control-description">' . esc_html( $this->description ) . '</span>'; } ?>  
    ...
    public function render_content() {
        ...
        $dropdown = wp_dropdown_categories(
            array(
                ...
                'echo'              => 0,
                'show_option_none'  => __( '&mdash; Select &mdash;', 'gabfire' ),
                'option_none_value' => '0',
                'hierarchical'      => 1, 
				'hide_empty'		=> 0,
				'orderby'            => 'name', 
    ...
    public function render_content() {
        ...
        if( empty( $this->menus ) )
	        ...
	        <label class="customize-control-select">
	            ...
	            <option value=""><?php _e( '&mdash; Select &mdash;', 'gabfire' ); ?></option>
	            <?php 
