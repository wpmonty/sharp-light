 ...
 * handled by a callback to gabfire_comments functions (inc/theme-functions.php)
 */
?>
...
<div id="comments">
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			 ...
			 * to use gabfire_comments() to format the comments.
			 * If you want to overload this in a child theme then you can
			 * define gabfire_comments() and that will be used instead.
			 * See gabfire_comments() in includes/theme-comments.php
			 */
			wp_list_comments( array( 'callback' => 'gabfire_comments' ) );
			?>
		</ol>
	...
	<?php if (get_option('comment_registration') && !$user_ID) : ?>
		...
		<?php if ( ! comments_open() ) : ?>
			<p class="alert alert-info"><?php _e( 'Comments are closed.' , 'gabfire' ); ?></p>
		<?php endif; ?>	
